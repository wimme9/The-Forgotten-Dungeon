...
function create() {
    // ==========================================
    // 1. วาดโครงสร้างห้องและเก็บพิกัด (เหมือนเดิม)
    // ==========================================
    ...
    corridors.push(new Phaser.Geom.Rectangle(120, 280, 80, 80)); // ทางเดินซ้าย
    corridors.push(new Phaser.Geom.Rectangle(550, 120, 50, 80)); // ทางเดินบน
    corridors.push(new Phaser.Geom.Rectangle(500, 480, 60, 80)); // ทางเดินล่าง
